import { LayoutGrid, Lightbulb, Layers, CalendarClock, Rewind, Rows3, TrendingUp, Grid3x3, BarChart3 } from "lucide-react";
...
export const NAV = [
  ...
  { href: "/strikes", label: "Strike Profile", icon: BarChart3, symbolScoped: false },
